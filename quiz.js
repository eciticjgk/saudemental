...
function getInfoBasedOnScore(){
    if(totalScore() < 10){
        var score_info = "Procure um especialista. Sua saúde mental está afetada.";
    } else if(totalScore() == 10){
        var score_info = "Tudo ok, mas pode melhorar! Procure um psicólogo."
    } else if(totalScore() > 10){
        var score_info = "Sua saúde mental está ótima! Parabéns!"
    }
